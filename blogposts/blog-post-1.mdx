...
description: A guide for bringing custom font files to your Chakra UI project running on Next.js
category: Web Development
image: /images/blog-post-1/banner.jpg
---
...
`fonts` folder. This is mostly to keep things tidy.
