...
image: /images/blog-post-2/banner.jpg
---

<Image alt={`YouTube To MP3 Logo`} src={`/static/images/building-my-first-electron-app/banner.png`} width={1200} height={630} priority />
...
<Image alt={`YouTube To MP3 Mockup 1`} src={`/static/images/building-my-first-electron-app/mock1.png`} width={919} height={525} />
<Image alt={`YouTube To MP3 Mockup 2`} src={`/static/images/building-my-first-electron-app/mock2.png`} width={919} height={525} />
...
<Image alt={`YouTube To MP3 Example`} src={`/static/images/building-my-first-electron-app/example.gif`} width={796} height={596} />
