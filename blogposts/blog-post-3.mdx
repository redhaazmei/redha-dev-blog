...
<Image alt={`Norway`} src={`/images/blog-post-3/banner.jpg`} width={1280} height={720} priority />
...
<Image alt={`Moskenes Ferry`} src={`/images/blog-post-3/ferry.jpg`} width={1280} height={720} />
